...
void FAureGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Effect_HealthPotion  = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Effect.HealthPotion"),
		FString("Increases Health Potion regeneration")
		);
	/*
	 * Primary Attributes
	 */
